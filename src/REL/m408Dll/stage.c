    ...
    switch (temp_r29->unk_02) {
        ...
        case 1:
            ...
            for (temp_r28 = 0; temp_r28 < particle->unk_30; temp_r28++, temp_r31++) {
                ...
                temp_r31->unk2C = temp_r31->unk24 * ((0.1f * sind(temp_r31->time)) + 1.0);
            }
            break;
    }
    DCFlushRange(particle->data, particle->unk_30 * sizeof(HU3DPARTICLEDATA));
...
void fn_1_F06C(ModelData *model, ParticleData *particle, Mtx matrix)
{
    ...
    switch (temp_r29->unk_02) {
        case 0:
            temp_r31 = particle->data;
            for (temp_r28 = 0; temp_r28 < particle->unk_30; temp_r28++, temp_r31++) {
                temp_r31->time = temp_r31->unk02 = 0;
            }
            temp_r29->unk_02++;
            break;
...
void fn_1_10484(UnkFn10484 *arg0, HSFFACE *arg1, HsfDrawData *arg2, GXColor *arg3)
{
    ...
    GXSETARRAY(GX_VA_POS, temp_r30->mesh.vertex->data, temp_r30->mesh.vertex->count * sizeof(HuVecF), sizeof(HuVecF), TRUE);
    if (temp_r25 & 0x2) {
        ...
        GXSETARRAY(GX_VA_NRM, temp_r30->mesh.normal->data, temp_r30->mesh.vertex->count * sizeof(HuVecF), sizeof(HuVecF), TRUE);
    }
    GXSetVtxDesc(GX_VA_TEX0, GX_INDEX16);
    GXSetVtxAttrFmt(GX_VTXFMT0, GX_VA_TEX0, GX_TEX_ST, GX_F32, 0);
    GXSETARRAY(GX_VA_TEX0, temp_r30->mesh.st->data, temp_r30->mesh.vertex->count * sizeof(HuVec2f), sizeof(HuVec2f), TRUE);
    if (temp_r25 & 0x4) {
        GXSetVtxDesc(GX_VA_CLR0, GX_INDEX16);
        GXSetVtxAttrFmt(GX_VTXFMT0, GX_VA_CLR0, GX_CLR_RGBA, GX_RGBA8, 0);
        GXSETARRAY(GX_VA_CLR0, arg3, arg0->unk4->mesh.color->count * sizeof(GXColor), sizeof(GXColor), TRUE);
    }
